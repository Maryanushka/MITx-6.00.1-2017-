# our task is to define the following two methods for the Coordinate class:
...
# looks like a valid Python expression that could be used to recreate
# an object with the same value. In other words, eval(repr(c)) == c given
